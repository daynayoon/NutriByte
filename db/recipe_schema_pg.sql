DROP TABLE IF EXISTS CanHave CASCADE;
DROP TABLE IF EXISTS RecipeReference CASCADE;
DROP TABLE IF EXISTS Contain CASCADE;
DROP TABLE IF EXISTS Rate CASCADE;
DROP TABLE IF EXISTS AddRelation CASCADE;
DROP TABLE IF EXISTS FoodCritic CASCADE;
DROP TABLE IF EXISTS RecipeCreator CASCADE;
DROP TABLE IF EXISTS Processed CASCADE;
DROP TABLE IF EXISTS Fresh CASCADE;
DROP TABLE IF EXISTS Nutrition2 CASCADE;
DROP TABLE IF EXISTS Nutrition1 CASCADE;
...
DROP TABLE IF EXISTS SavedLists CASCADE;
...
INSERT INTO AddRelation VALUES (1, 6);
INSERT INTO AddRelation VALUES (3, 7);
INSERT INTO AddRelation VALUES (4, 8);
INSERT INTO AddRelation VALUES (2, 9);
INSERT INTO AddRelation VALUES (3, 10);
...
INSERT INTO Contain VALUES (6, 3);
INSERT INTO Contain VALUES (6, 4);
INSERT INTO Contain VALUES (6, 6);
INSERT INTO Contain VALUES (6, 8);
INSERT INTO Contain VALUES (8, 4);
